...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = "/data/parkjun210/Detect_Recog/Code_face_recog/applications/align/source", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = "/data/parkjun210/Detect_Recog/Code_face_recog/applications/align/dest", type = str)
